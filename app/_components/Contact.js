  ...
  return (
    <div className=' flex justify-center items-center mt-32'>
        <div className='shadow-[0px_0px_20px_0px_#3182ce] flex rounded-3xl justify-between items-center  sm:w-[80%] mx-7 sm:mx-0'>
            <form action="https://formsubmit.co/parnika2005@gmail.com" method="POST" className='rounded-3xl sm:shadow-[0px_0px_100px_0px_#3182ce] p-12 sm:p-16 w-full flex gap-5  flex-col justify-center items-start'>
                ...
                <Button variant="outline" className="w-[50%] bg-secondary">Submit</Button>
            </form>
